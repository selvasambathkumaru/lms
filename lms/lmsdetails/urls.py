...
from . import views
from .views import LeaveRequestView, LeaveRequestListView, LeaveRequestViewSet, UserListCreateView,UserRetrieveUpdateDestroyView, AdminListCreateView, EmployeeListCreateView, AdminView, EmployeeView, LeaveRequestByEmployeeView
...
urlpatterns = [
    ...
    path('leave-request-by-employee/<str:employee_name>/', LeaveRequestByEmployeeView.as_view()),
    ...
    path('leave-request/<str:employee_name>/', LeaveRequestView.as_view()),
]